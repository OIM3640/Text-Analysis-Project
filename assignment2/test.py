...
def print_most_common(hist, num=10):
    ...
    for frequency, word in common_words:
...
def random_word(hist):
    ...
    for word, frequency in hist.items():
        ...
        if rand_num <= total_freq:
            return word


def main():
    hist = process_file('data/Pride_and_Prejudice.txt', skip_header=True)
    # print(hist)
    ...
    words = process_file('Pride_and_Prejudice.txt', skip_header=False)
